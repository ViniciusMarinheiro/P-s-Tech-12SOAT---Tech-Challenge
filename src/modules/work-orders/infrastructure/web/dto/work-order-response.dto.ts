...
export class WorkOrderServiceResponseDto {
  @ApiProperty({ description: 'ID do serviço na ordem', example: 1 })
  id: number
...
export class WorkOrderPartResponseDto {
  @ApiProperty({ description: 'ID da peça na ordem', example: 1 })
  id: number

  @ApiProperty({ description: 'ID da peça', example: 1 })
  partId: number

  @ApiProperty({ description: 'Nome da peça', example: 'Óleo de motor 5W30' })
  partName: string
...
class CustomerResponseDto {
  ...
  @ApiProperty({ description: 'Nome do cliente', example: 'João Silva Santos' })
  name: string

  @ApiProperty({ description: 'Email do cliente', example: 'joao@gmail.com' })
  email: string
}
...
export class WorkOrderResponseDto {
  @ApiProperty({ description: 'ID da ordem de serviço', example: 1 })
  id: number

  @ApiProperty({ description: 'ID do cliente', example: 1 })
  customerId: number

  @ApiProperty({ description: 'Cliente', type: CustomerResponseDto })
  customer: CustomerResponseDto

  @ApiProperty({ description: 'ID do usuário', type: UserResponseDto })
  user: UserResponseDto

  @ApiProperty({ description: 'Veículo', type: VehicleResponseDto })
  ...
  @ApiProperty({ description: 'Tempo de conclusão em minutos', example: 150 })
  timeToFinish?: number

  @ApiProperty({ description: 'Tempo de conclusão', example: '2h 30m' })
