...
export class WorkOrdersController {
  constructor(
    ...
    private readonly findAllWorkOrdersUseCase: FindAllWorkOrdersUseCase,
    private readonly findWorkOrderByIdUseCase: FindWorkOrderByIdUseCase,
    private readonly findByCustomerDocumentUseCase: FindWorkOrdersByCustomerDocumentUseCase,
    private readonly getProgressUseCase: GetWorkOrderProgressUseCase,
  ...
  findAll(@Query() workOrderFilterDto: WorkOrderFilterDto) {
    return this.findAllWorkOrdersUseCase.execute(workOrderFilterDto)
  }
  ...
  findByCustomerDocument(@Param('document') document: string) {
    return this.findByCustomerDocumentUseCase.execute(document)
  }
  ...
  @ApiParam({ name: 'id', description: 'ID da ordem de serviço', example: 1 })
  findOne(@Param('id') id: string) {
    return this.findWorkOrderByIdUseCase.execute(+id)
  }
  ...
  update(
    ...
    return this.updateWorkOrderUseCase.execute(+id, updateWorkOrderDto)
  }
  ...
  findByHashView(@Param('hashView') hashView: string) {
    return this.findByHashViewUseCase.execute(hashView)
  }
